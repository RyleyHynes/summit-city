...
//     //setting initial state of myBucketListHikes 
//     const [myBucketListHikes, setMyBucketListHikes] = useState([])
//     //setting the initial hike state to false for toggle purposes
//     const [hikeCompleted, setHikeCompleted] = useState(false)
//     const [searchTerms, setSearchTerms] = useState("")
//     const [filteredCompletedHike, setFilteredCompletedHike] = useState([])
//     const [filteredBucketListHike, setFilteredBucketListHike] = useState([])
...
//         <>
//             {
//                 hikeCompleted ? <><h2 className="showForm_title">Your Saturday Schedule</h2>
//                     <article>
...
//                         <article>
//                             <div className="topButtons">
//                                 <button className="dayButtons" onClick={() => setHikeCompleted(false)}>Friday</button>
//                                 <button className="dayButtons" onClick={() => setHikeCompleted(true)}>Saturday</button>
//                             </div>
//                             <input
//                                 className="input search mx-4"
//                                 type="text"
